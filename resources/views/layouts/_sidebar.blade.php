...
<div id="left-sidebar" class="sidebar">
    <div class="navbar-brand">
        <a href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/images/download.png') }}" alt="Smart School Logo" class="img-fluid">
        </a>
        <b><div class="tahun-ajaran" style="font-size: 14px;">SIPO</div></b>
        <div class="tahun-ajaran" style="font-size: 14px;">Tahun Ajaran: {{ date('Y') }} - {{ date('Y') + 1 }}</div>

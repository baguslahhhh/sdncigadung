...
<div class="block-header">
    ...
    <div class="pb-3">
        <h5 class="color-black font-weight-bold text-capitalize">daftar materi</h5>
        <div id="render-content" style="display: none;">

        </div>
        <div id="loading-content" style="display: none;">
            <a class="color-black font-weight-bold">Terdapat <span class="text-white">...</span> Materi!</a>
            <div class="mt-3">

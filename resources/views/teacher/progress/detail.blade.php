        ...
        <div class="row mt-3">
            ...
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#content">Materi</a></li>
                    <!-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exercise">Latihan</a></li> -->
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exam">Quiz</a></li>
                </ul>

...
<div class="block-header">
    ...
    <div class="alert alert-primary my-4 rounded" role="alert">
        <div class="d-flex align-items-center">
            ...
            Terbitkan materi agar siswa dapat membaca atau menonton materi yang diberikan.
        </div>
    </div>
    ...
    <div class="bg-white mt-3 px-3 py-4 text-dark">
        <form>
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="title" placeholder="Masukkan judul Materi" name="title">
            </div>
            <div class="form-group mb-3">
